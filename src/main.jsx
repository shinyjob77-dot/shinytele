  ...
  return (
    <main className="site-shell">
      <header className="topbar">
        ...
        <a className="nav-action" href="#book">
          Book Visit
        </a>
      </header>
      ...
      <section className="weight-loss-page" id="weight-loss">
      ...
      <section className="booking-section" id="book">
        <div className="booking-copy">
          ...
          <p>
            Share your contact information and preferred visit time. A care
            coordinator can confirm your appointment and help you prepare.
          </p>
      ...
      <section className="portal-section" id="portal">
        ...
        <div className="portal-panel">
          ...
          <a className="secondary-button" href="#intake">
            Continue to Intake
            <ChevronRight size={18} aria-hidden="true" />
          </a>
        </div>
